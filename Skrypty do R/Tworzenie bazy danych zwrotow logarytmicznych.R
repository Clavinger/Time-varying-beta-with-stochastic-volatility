...
data.poczatkowa='2015-04'
#koniec okresu badania
data.koncowa='2016-03'
############################################
...
#wczytanie tiker?w z pliku
tikery=as.matrix(read.csv2(file="tikery.csv"))
tikery=tikery[,-1]


##############################################################################
#wczytywanie danych spelniajace krytyk?w 
...
#przyciecie wig do okresu badania
wig.zwroty=read.csv.zoo("wig_zwroty.csv",sep=',')
wig.zwroty=as.xts(wig.zwroty)
wig.zwroty.sub=wig.zwroty[paste(data.poczatkowa,"/",data.koncowa,sep="")]
write.zoo(wig.zwroty.sub,file="wig_zwroty_sub.csv",sep=',')
##############################################################################
...
#przyklad jak odczytywa? baze danych
